...
(function() {
    ...
    var n = {
        ...
        buttonLayout: {
            ...
            Button: t(function(e) {
                ...
                refresh: function() {
                    ...
                    this.imageId == "" ? (this.bgColor != "" && m.canvas.fillStyle(this.bgColor).fillRect(0, 0, this.width, this.height).fillRect(this.width, 0, this.width, this.height).fillRect(this.width * 2, 0, this.width, this.height),
                    this.bgStroke != "" && m.canvas.strokeStyle(this.bgStroke).strokeRect(1, 1, this.width - 2, this.height - 2).strokeRect(this.width + 1, 1, this.width - 2, this.height - 2).strokeRect(this.width * 2 + 1, 1, this.width - 2, this.height - 2)) : m.canvas.drawImage(this.imageId, this.sx, this.sy, this.width, this.height, 0, 0, this.width >> 1, this.height >> 1).drawImage(this.imageId, this.hx, this.hy, this.width, this.height, this.width, 0, this.width >> 1, this.height >> 1).drawImage(this.imageId, this.dex, this.dey, this.width * 2, this.height, this.width * 2, 0, this.width, this.height);
                    if (this.value != "") {
                ...
                render: function() {
                    return this.hided ? this : (m.canvas.drawCache(this.cacheId, this.hovered ? this.width : this.disabled ? this.width * 2 : 0, 0, this.width, this.height, this.x, this.y, this.width, this.height),
                    this)
                },
                disposed: function() {
                    return this
        ...
        keydown: function(e) {
            ...
            n.event.keyPressCtrl[t] && n.event.keyPressedGo && (n.event.pressedKey[t] != undefined && (n.event.pressedKey[t] = !0),
            n.event.keyPressCtrl[t] = !1),
        ...
        keyup: function(e) {
            ...
            n.event.keyPressedGo && (n.event.pressedKey[t] != undefined && (n.event.pressedKey[t] = !1),
            n.event.keyPressCtrl[t] = !0),
        ...
        swipeStart: function(e, t) {
            n.event.swipeCallBack != null && (n.event.swipeDate = Date.now(),
            n.event.pageStarOffX = e,
            n.event.pageStarOffY = t)
        },
            ...
            if (n.event.swipeDate) {
                if (Date.now() - n.event.swipeDate < n.event.swipeTimeout)
                    if (Math.abs(e - n.event.pageStarOffX) >= n.event.swipeRange || Math.abs(t - n.event.pageStarOffY) >= n.event.swipeRange)
                        return n.event.swipeCallBack(n.event.pageStarOffX, n.event.pageStarOffY, e, t),
                        !0;
        ...
        setImage: function(e, t, r, i, s) {
            if (!e || !t)
                return !1;
            n.image.imgs[e] || (n.image.imgs[e] = new Image,
            n.image.imgs[e].onload = function() {
                n.image.countLoaded++,
                this.loaded = !0,
                this.cache && m.canvas.pass(this.id, this.width, this.height).drawImage(this.id, 0, 0).pass().base().delImage(this.id, !0)
            }
            ,
            n.image.imgs[e].src = t + (n.image.version != "" ? "?v=" + n.image.version : ""),
            n.image.imgs[e].id = e,
            n.image.imgs[e].url = t,
            n.image.imgs[e].benchId = r,
            n.image.imgs[e].bench = i,
            n.image.imgs[e].cache = s,
            n.image.imgs[e].refreshed = !1)
        },
        ...
        initUrlParams: function(e) {
            if (e.indexOf("?") >= 0) {
                ...
                for (var s = 0; s < r.length; s++)
                    r[s].indexOf("=") >= 0 && (i = r[s].split("="),
                    n.request.gets[i[0]] = i[1]);
                i = null,
                r = null,
                t = null
            }
    ...
    link = {
        init: function(e, t) {
            ...
            this.sessionStorage.init()) : (n.canvas.defaultWidth = e,
            n.canvas.defaultHeight = t),
            this
        },
        extend: t,
        setAjax: function(e) {
        ...
        ajax: function(e) {
            ...
            n.ajax.xhr.onreadystatechange = function() {
                ...
                var e = n.ajax.xhr
                  , t = n.ajax.xhrObj;
                if (t && e.readyState == 4) {
                    n.ajax.date && (clearTimeout(n.ajax.date),
                    n.ajax.date = null);
                    if (e.status == 200) {
                        var r;
                        switch (t.dataType) {
            ...
            if (n.ajax.xhrObj == null && n.ajax.pool.length > 0) {
                ...
                n.ajax.date = setTimeout(function() {
                    ...
                    n.ajax.isTimeout = !0,
                    n.ajax.xhrObj && (n.ajax.xhrObj.error(n.ajax.xhrObj, "timeout"),
                    n.ajax.xhrObj = null)
        ...
        comm: {
            ...
            createPath: function(e, t, n, r, i) {
                var s = [], o = e || 0, u = t || 0, a = n || 0, f = r || 0, l = a - o, c = f - u, h = Math.sqrt(Math.pow(l, 2) + Math.pow(c, 2)), p = i || 5, d = p, v = 0, m = 0, g, y, b = Math.atan2(c, l) / Math.PI * 180;
                b = b >= 0 ? b : b + 360,
                d >= h && (d = h >> 1);
                while (d < h + p)
                    d = d > h ? h : d,
        ...
        pageLoad: function(e) {
            return n.system.pageLoad == null && (n.system.pageLoad = e,
        ...
        main: function(e) {
            ...
            t && (this.canvas.screen.getTouch() ? (window.addEventListener("orientationchange", i.orientationchange, !1),
            ...
            t.addEventListener("touchcancel", i.touchcancel, !1)) : (document.onkeydown = i.keydown,
            document.onkeyup = i.keyup,
            ...
            window.addEventListener("pagehide", i.pageUnFocus, !1)) : (s == "firefox" && (n.event.focused = !0),
        ...
        play: function() {
            return n.system.run || (n.system.run = function() {
                ...
                case r.system.gameFlowType.loadImage:
                    if (i.loadingCallBack != null) {
                        ...
                        s == t && i.loadingEndCallBack && (i.loadingEndCallBack(s, t, "image"),
                        i.loadingEndCallBack = null),
                        s = t = null
                    }
                    break;
            ...
            (n.system.rafRun = function() {
                var e = Date.now();
                e - n.system.lastDate >= n.system.timeout - n.system.spendTime && (n.system.lastDate = e,
                n.system.isPause || n.system.run()),
                e = null,
        ...
        pause: function() {
            ...
            n.system.rafRun = null,
            cancelAnimationFrame(n.system.playTimer),
            n.system.playTimer = null),
            this
        },
        gameFlow: {
            menu: function() {
                return n.system.menu != null && (n.system.gameFlow = r.system.gameFlowType.menu,
                m.resetKeys()),
                this
            },
            run: function() {
                return n.system.runFn != null && (n.system.gameFlow = r.system.gameFlowType.run,
                m.resetKeys()),
                this
            },
            stop: function() {
            ...
            over: function() {
                return n.system.over != null && (n.system.gameFlow = r.system.gameFlowType.over,
                m.resetKeys()),
                this
            },
            zone: function(e) {
                return n.system.zone != null && (n.system.gameFlow = r.system.gameFlowType.zone,
                n.system.zoneArgs = e,
                m.resetKeys()),
                this
            },
            active: function(e) {
                return n.system.active != null && (n.system.gameFlow = r.system.gameFlowType.active,
                n.system.activeArgs = e,
                m.resetKeys()),
                this
            },
            isIn: function(e) {
        ...
        canvas: {
            ...
            pass: function(e, t, r) {
                ...
                n.canvas.ctxs[i] || (o = this.base().getDom(i) || document.createElement("canvas"),
                n.canvas.ctxs[i] = null,
                delete n.canvas.ctxs[i],
                n.canvas.ctxs[i] = o.getContext("2d"),
                ...
                n.canvas.cavansDoms[i] = null,
                delete n.canvas.cavansDoms[i],
            ...
            del: function(e) {
                return n.canvas.ctxs[e] && (n.canvas.ctxs[e] = null,
                delete n.canvas.ctxs[e],
                n.canvas.cavansDoms[e] = null,
                delete n.canvas.cavansDoms[e]),
                this
            },
            ...
            screen: {
                ...
                setWidth: function(e) {
                    ...
                    c && (c.width = n.canvas.defaultWidth,
                ...
                setHeight: function(e) {
                    ...
                    c && (c.height = n.canvas.defaultHeight,
            ...
            fillRect: function(e, t, n, r, o) {
                return n = n ? n : 0,
                r = r ? r : 0,
                o ? f = i.getAnchor(e, t, n, r, o) : (f.x = e,
                f.y = t),
            ...
            strokeRect: function(e, t, n, r, o) {
                return o ? a = i.getAnchor(e, t, n, r, o) : (a.x = e,
                a.y = t),
            ...
            setColor: function(e, t, n) {
                return n == null ? (u.fillColor = e,
                u.strokeColor = t ? t : e) : (u.fillColor = "rgb(" + e + ", " + t + ", " + n + ")",
            ...
            drawImage: function(e, t, r, u, a, f, l, c, h, p) {
                ...
                if (d.refreshed)
                    ...
                    s.drawImage(d, t, r, u, a, o.x, o.y, c, h)) : s.drawImage(d, t, r, u, a, f, l, c, h) : (o = i.getAnchor(t, r, d.width, d.height, u),
                    s.drawImage(d, o.x, o.y)) : s.drawImage(d, t, r));
                else {
                    var v = n.image.asyncImgObjs[e];
                    v && !v.inited && (i.setImage(v.id, v.src, v.benchId, v.bench, v.cache),
                    v.inited = !0),
                    v = null
                }
                return d = null,
            ...
            drawString: function(e, t, i, o, u, a, f, c) {
                ...
                return u && (a ? l.fillStyle = a : l.fillStyle = "#000000",
                f ? l.strokeStyle = f : l.strokeStyle = "#CCCCCC",
        ...
        pushImage: function(e, t) {
            ...
            for (var i = 0, s = e.length; i < s; i++)
                r = e[i],
                r && !n.image.initImgs[r.id] && (n.image.initImgs[r.id] = !0,
                n.image.imgObjs.push(e[i]));
        ...
        delImage: function(e, t) {
            return n.image.imgs[e] && (n.image.imgs[e] = null,
            delete n.image.imgs[e],
            t && (n.image.imgs[e] = {
                id: e,
                loaded: !0,
                cache: !0,
        ...
        audio: {
            ...
            del: function(e) {
                var t = n.audio.audios[e];
                return t && t.__timeupdateCallBack__ && (t.pause(),
                t.removeEventListener("timeupdate", t.__timeupdateCallBack__, !1),
                n.audio.audios[e] = null,
                delete n.audio.audios[e]),
                t = null,
                this
            },
            base: function() {
    ...
    link.getScript = function(e) {
        ...
        return t.url != "" && (t.before(),
        y = document.createElement("script"),
        y.type = t.contentType,
        y.async = !0,
        y.src = t.url,
        y.destroyed = t.destroyed,
        w = t.success,
        E = t.error,
        y.onload = function() {
            S(),
    ...
    typeof define == "function" && define("lib/link", [], function() {
        return link
    })
}
)(),
define("lib/action", ["lib/link"], function(e) {
    ...
    e.action.Role.prototype.setSprite = function(t, n, r) {
        ...
        this._cr != i && (this._cr = i,
        i < 0 && (i = Math.abs(i)),
        this.current = i >= this.sprites.length ? this.sprites.length - 1 : i,
        this.sprites.length > 1 && this.setTrans(s),
        o = this.getSprite(),
        u = o.getFrame(),
        n || o.setFrame(0),
        r && (this._stopedAction = this._cr),
    ...
    e.action.Role.prototype.action = function() {
        ...
        if (n) {
            ...
            if (this._path.length > 0) {
                ...
                this.svx != null && this.svy != null && (this._skipMoveDs || (this.setSprite(this._stopedAction || this._stopDs[this.dsIndex = t(this.svx, this.svy)]),
                this._stopedAction = null),
    ...
    e.action.Role.prototype.setRotate = function(e) {
        return e != this.angle && (Math.abs(e) > 360 && (e %= 360),
        this.angle = e < 0 ? 360 + e : e),
        this
    }
    ,
    ...
    e.action.Sprite.prototype.nextFrame = function() {
        return !this.loop && this.endFrame() ? this : (this.frames.length > 0 && (this.runStep <= 0 ? (this.loop ? (this.current++,
        this.current %= this.frames.length) : this.current < this.frames.length - 1 && this.current++,
        this.getFrame().step ? this.runStep = this.getFrame().step : this.runStep = this.step) : this.runStep--),
        this)
    }
    ,
    e.action.Sprite.prototype.preFrame = function() {
        return this.frames.length > 0 && (this.runStep <= 0 ? (this.loop ? (this.current--,
        this.current < 0 && (this.current = this.frames.length - 1)) : this.current > 0 && this.current--,
        this.getFrame().step ? this.runStep = this.getFrame().step : this.runStep = this.step) : this.runStep--),
        this
    }
    ,
    ...
    ;
    var r, i = function(e) {
        return e.sprites.length > 0 ? e.sprites[0].frames.length > 0 && (e.sprites[0].runStep <= 0 ? (e.sprites[0].runStep = e.sprites[0].step,
        r = e.sprites[0].frames.shift(),
        e.sprites[0].frames.length == 0 && e.sprites.shift()) : (r = e.sprites[0].getFrame(),
        e.sprites[0].runStep--)) : r = null,
        r
    };
...
define("host", ["lib/link"], function(e) {
    ...
    //   , n = [[[0, 0, 26, 37], [27, 0, 19, 36], [46, 0, 22, 38]]]
      , n = [[[0, 0, 145, 135], [146, 0, 140, 135], [286, 0, 140, 135], [426, 0, 140, 135]]]
      , r = [{
        aR: [-15, -30, 30, 30],
        bR: [-10, -25, 20, 20],
        fA: [[0, 0, -72, -321, 0]]
      ...
      , i = [{
        loop: !0,
        frames: [[0, 0, 0, 0], [1, 0, 0, 0], [2, 0, 0, 0], [3, 0, 0, 0], [2, 0, 0, 0], [1, 0, 0, 0]]
    }];
    return {
        get: function(s, o) {
            var u = s >= 0 && i[s] ? [i[s]] : i;
...
define("shine", ["lib/link"], function(e) {
    ...
    var t = ["shine"]
      , n = [[[0, 0, 280, 230], [280, 0, 290, 230], [570, 0, 270, 230], [840, 0, 200, 230]]]
      , r = [{
        aR: [-15, -30, 30, 30],
        bR: [-10, -25, 20, 20],
        fA: [[0, 0, -85, -265, 0]]
...
define("index", ["lib/link", "lib/action", "host", "shine"], function(e, t, n, r) {
    return {
        init: function() {
            ...
            e.canvas.screen.getTouch() ? (i = window.innerWidth,
            s = window.innerHeight,
            e.canvas.screen.setWidth(i).setHeight(s),
            u = s - o >> 1) : (window.onresize = function() {
                i = window.innerWidth,
                s = window.innerHeight,
                e.canvas.screen.setWidth(i).setHeight(s),
                u = s - o >> 1
            ...
            e.run(function() {
                ...
                .drawImage("bgImg", 0, 0, 750, 1334, 0, 0, i,window.innerHeight );
                var n = ~~(o / l.scenes.length);
                if (!l.died) {
                    l.time = t - l.date;
                    for (var s = 0, f; f = l.scenes[s]; s++) {
                        s===1 ? f.action(0, u + (s + 0.54) * n, i, n, -8).render() : f.action(0, u + (s + 1) * n, i, n, -8).render();
                        if (f.hostDied) {
                            l.died = !0,
                            l.dieDate = Date.now(),
                    ...
                    for (var s = 0, f; f = l.scenes[s]; s++)
                        f.host.action(),
                        f.render();
                    l.shine && (l.shine.action().render(),
                    l.shine.getSprite().endFrame() && (l.shine = null)),
                    t - l.dieDate >= l.dieTimeout && (l.dieDate = null,
                    h())
                }
                var c = a(l.time);
                ...
                e.canvas.fillStyle("#FFF").fillScreen()
                .drawImage("startBg", 0, 0, 750, 1334, 0, 0, i,s )
                // .drawImage("logo", i - 480 >> 1, u)
                // .drawImage("btns1", 0, 99, 480, 7, i - 480 >> 1, u + 140, 480, 7)
                // .drawImage("btns1", 0, 99, 480, 7, i - 480 >> 1, u + 555, 480, 7),
                e.buttonLayout.released("difficulty1") ? (l.moduleName = "",
                hideAd(),
                c(2)) : e.buttonLayout.released("difficulty2") ? (l.moduleName = "噩梦模式",
                c(3)) : e.buttonLayout.released("difficulty3") ? (l.moduleName = "地狱模式",
                c(4)) : e.buttonLayout.released("difficulty4") ? (l.moduleName = "炼狱模式",
                c(5)) : e.buttonLayout.released("rank") && dp_Ranking()
            }).zone(function() {
                e.canvas.fillStyle("#90EE90").fillScreen().fillStyle("#FFF")
                .drawImage("endBg", 0, 0, 750, 1334, 0, 0, i,s )
                ...
                .fillStyle("#ff9fc9").drawString(a(l.time, ""), 0, u + 330, e.graphics.VCENTER, !1, null, null, "30px 微软雅黑")
                .fillStyle("#96aef4").drawString("" + a(l.bestTime, ""), 0, u + 355, e.graphics.VCENTER, !1, null, null, "16px 微软雅黑"),
            ...
            var l = {
                ...
                Scene: e.extend(function(t) {
                    ...
                    render: function() {
                        // e.canvas.fillStyle("#80e4f6").fillRect(this.x, this.baseY - 100, this.width, 5);
                        e.canvas.fillStyle("#B5FBFF").drawImage("run", 0, 0, 750, 48, this.x, this.baseY - 105, this.width, 18 );
                        for (var t = this.boxes.length - 1, n; n = this.boxes[t]; t--)
                            e.canvas.fillRect(n.x, n.y - 94, n.width, n.height);
                    ...
                    action: function(t, n, r, i, s) {
                        ...
                        if (!this.hostDied) {
                            ...
                            for (var f = this.boxes.length - 1, l; l = this.boxes[f]; f--)
                                ...
                                this.host.collisionInput(l.x, l.y, l.width, l.height, "bR") && (this.hostDied = !0,
                                this.host.clearPath()),
                    ...
                    touchStart: function(t, n) {
                        return this.host.endPath() ? (e.comm.collision(t, n, 1, 1, this.x, this.baseY === 343 ? this.baseY - 96 - this.height : this.baseY + 55 - this.height, this.width, this.baseY === 343 ? this.height : this.height - 145) && this.host.setPath([[0, -20], [0, -20], [0, -20], [0, -10], [0, -10], [0, -10], [0, -5], [0, -5], [0, -5], [0, 5], [0, 5], [0, 5], [0, 10], [0, 10], [0, 10], [0, 20], [0, 20], [0, 20]]),
                        this) : this
                    }
                })
            }
