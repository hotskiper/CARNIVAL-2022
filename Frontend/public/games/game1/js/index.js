    ...
    $AJB.general.Game = function() {
        ...
        function e() {
            n(document.body, "mousedown", function(a) {
				...
				n(v2, "mousedown", function() {
                    var name=prompt("请输入关卡(总共60关)","");
					if (name!=null && name!=""){
						if(!isNaN(name)){
							E || (E = !0, t.style.display = "", d(name), setTimeout(function() {
                            t.style.display = "none",
                            E = !1
							alert("跳到关卡完成");
                            }, 100))
        ...
        var h, i, j, k = $AJB.general.Scene(),
			...
			v2 = document.getElementById("btnReset2"),
